            ...
            <form action="" method="POST" onsubmit="false">
                ...
                <div class="form-inline mb-3">
                    ...
                    <input class="form-control" type="text" size="70" id="inputTitle" name="noticeTitle"
                        placeholder="공지사항 제목을 입력해주세요" value="서버 점검 지연 안내">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control my-3" rows="20" id="content" name="boardContent">
서버점검이 지연되고 있습니다.
죄송합니다.
                    </textarea>
                </div>
                ...
                <div class="d-flex" id="btn-wrapper">
                    ...
                    <!-- 수정, 삭제 버튼 -->
                    <div class="ml-auto">
                        <button type="button" class="btn main-btn">수정하기</button>
                        <button type="button" class="btn del-btn">삭제하기</button>
                    </div>
                </div>
